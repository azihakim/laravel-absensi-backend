		...
		<section class="section">
			<div class="section-header">
				...
				<div class="section-header-breadcrumb">
					...
					<div class="breadcrumb-item">Create Session</div>
				</div>
			</div>
						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<select name="dosen_id" class="form-control select2 @error('dosen_id') is-invalid @enderror">
									...
									@foreach ($dosens as $dosen)
										<option value="{{ $dosen->id }}" {{ old('dosen_id') == $dosen->id ? 'selected' : '' }}>{{ $dosen->name }}
										</option>
									@endforeach
								</select>
								@error('dosen_id')
							...
							<div class="form-group">
								...
								<select name="status" class="form-control @error('status') is-invalid @enderror">
									<option value="on" {{ old('status', 'on') == 'on' ? 'selected' : '' }}>On</option>
